...
<thead> 
	<tr> 
		<td colspan = "5" valign = "middle"><a href = "javascript: localSubmitForm(new Array( 'menu', 'status' , 'desc' ),new Array(  'shortmsg' , 'new' , 'ข่าวสั้น' ))"><img src="images/icn_new_article.png" width = "25" height = "25" title = "สร้างใหม่"></a></td> 
	</tr>
	<?php
	...
	try
	{
		...
		$noOfPage = $dataTable->getPageCount( $db ,  "tb_b_shortmsg" , $condition , $recPerPage );

		//Prepare column display on datatable
		$colArray = array( "id" , "short_msg_th");
		$colNameArray = array( "short_msg_th" , "action" );
		$colDescArray = array( "หัวข้อ" , "Action" );
		$colTypeArray = array(  "text" , "action-M|E|D" );

		//Get data for data table
		$data =  $dataTable->getData( $db ,  "tb_b_shortmsg" , $condition , $colArray) ;

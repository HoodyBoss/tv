...
$base_url="http://118.175.48.147:8251"; //url base of site if you want only relative url leave empty
$upload_dir = '/backend/assets/'; // path from base_url to upload base dir
